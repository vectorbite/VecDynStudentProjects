...
dataset_doi <- vectorbite$Citations
...
a <- cbind(title, dataset_doi, description, contact_name, dataset_license, taxon, sample_value, sample_sex, sample_stage, sample_end_date, sample_lat_dd, sample_long_dd, location_description, sampling_method, sampling_protocol)
