...
library(RNCEP)
## Ensure the vecdyn_mcm_2012 is in your global environment, if not run through the previous Mapping exercise  
## In this example,  we use the datetime and locational data
## obtained from the trap locations
...
NCEP.vis.points(lats=gull$latitude, 
