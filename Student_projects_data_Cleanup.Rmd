...
The GDPP data will pose a slight challenge when converting them to the VecDyn format as the GPDD does not store exact
sampling dates,  instead observations are temporally coded. You'll need to convert these into time stamped dates. More info below. 
