...
Along with the time series data, we need minimal amounts of information,  that can help us make informed decisions about the quality of the data e.g. was it measured accurately using the best equipment and do the methods used to select the sample represent the population in question. These concepts can be represented as follows:
...
Your challenge will be to clean-up and process data-sets, mapping them to the vecdyn template. You'll probably need to use a number of packages and techniques to achieve this. You should refer to the 'R for Data Science guide'(https://r4ds.had.co.nz/) or materials you have been provided by Imperial.  
